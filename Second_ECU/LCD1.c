...
extern void LCD_Init(void)
{
	...
	DIO_voidSetPinDirection(DIO_PIN14, DIO_OUTPUT);   //PB6 RS
	DIO_voidSetPinDirection(DIO_PIN15, DIO_OUTPUT);   //PB7 R/W
	DIO_voidSetPinDirection(DIO_PIN2, DIO_OUTPUT);    //PA2 E
	/*-----------------------------------------------------------------*/
